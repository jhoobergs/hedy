...
export type HedyL2Statement = { type: "print", content: [HedyL2Expression, string | null] } | { type: "expr", content: HedyL2Expression } | { type: "comp", content: Array<HedyL2Statement> } | { type: "color", content: HedyL2Expression } | { type: "forward", content: HedyL2Expression } | { type: "turn", content: HedyL2Expression } | { type: "assign_statement", content: [string, HedyL2Expression] } | { type: "sleep", content: HedyL2Expression };// This file was generated by [ts-rs](https://github.com/Aleph-Alpha/ts-rs). Do not edit this file manually.
...
export type HedyL3Statement = { type: "print", content: [HedyL3Expression, string | null] } | { type: "expr", content: HedyL3Expression } | { type: "comp", content: Array<HedyL3Statement> } | { type: "color", content: HedyL3Expression } | { type: "forward", content: HedyL3Expression } | { type: "turn", content: HedyL3Expression } | { type: "assign_statement", content: [string, HedyL3Expression] } | { type: "sleep", content: HedyL3Expression } | { type: "list_remove_stmt", content: [HedyL3Expression, string] } | { type: "list_add_stmt", content: [HedyL3Expression, string] };// This file was generated by [ts-rs](https://github.com/Aleph-Alpha/ts-rs). Do not edit this file manually.
...
export type HedyL2IPStatement = { type: "print", content: [HedyL2IPExpression, string | null] } | { type: "expr", content: HedyL2IPExpression } | { type: "comp", content: Array<HedyL2IPStatement> } | { type: "color", content: HedyL2IPExpression } | { type: "forward", content: HedyL2IPExpression } | { type: "turn", content: HedyL2IPExpression } | { type: "assign_statement", content: [string, HedyL2IPExpression] } | { type: "sleep", content: HedyL2IPExpression };// This file was generated by [ts-rs](https://github.com/Aleph-Alpha/ts-rs). Do not edit this file manually.
