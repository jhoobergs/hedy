...
export type HedyL2Statement = { type: "print", content: HedyL2Expression } | { type: "expr", content: HedyL2Expression } | { type: "comp", content: Array<HedyL2Statement> } | { type: "color", content: HedyL2Expression } | { type: "forward", content: HedyL2Expression } | { type: "turn", content: HedyL2Expression } | { type: "assign", content: [string, HedyL2Expression] } | { type: "sleep", content: HedyL2Expression };// This file was generated by [ts-rs](https://github.com/Aleph-Alpha/ts-rs). Do not edit this file manually.
...
export type HedyL3Statement = { type: "print", content: HedyL3Expression } | { type: "expr", content: HedyL3Expression } | { type: "comp", content: Array<HedyL3Statement> } | { type: "color", content: HedyL3Expression } | { type: "forward", content: HedyL3Expression } | { type: "turn", content: HedyL3Expression } | { type: "assign", content: [string, HedyL3Expression] } | { type: "sleep", content: HedyL3Expression };// This file was generated by [ts-rs](https://github.com/Aleph-Alpha/ts-rs). Do not edit this file manually.
